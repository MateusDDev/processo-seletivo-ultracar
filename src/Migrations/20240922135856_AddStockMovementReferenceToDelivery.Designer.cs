...
namespace processo_seletivo_ultracar.Migrations
{
    ...
    [Migration("20240922135856_AddStockMovementReferenceToDelivery")]
    partial class AddStockMovementReferenceToDelivery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ultracar.Models.Delivery", b =>
                {
                    ...
                    b.HasOne("Ultracar.Models.StockMovement", "StockMovement")
                        .WithMany()
